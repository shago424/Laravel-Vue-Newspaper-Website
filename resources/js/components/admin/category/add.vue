        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6">
            <div class="panel panel-primary panel-outline" style="border:solid 3px lightgreen">
              ...
              <h5 class="card-title p-2 font-weight-bold">Add Category</h5>
               <div class="text-right p-2">
               <router-link to="/list-category" class="btn btn-primary font-weight-bold">Category List</router-link>
              </div>
              </div>
              <div class="panel-body p-3">
                <form role="form" @submit.prevent='categorySave'>
                  ...
                  <div class="form-group">
                    ...
                    <input v-model="form.name"  type="text" name="name"  class="form-control" :class="{ 'is-invalid': form.errors.has('name') }" id="name" placeholder="Enter Category Name">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-success font-weight-bold">Add Category</button>
