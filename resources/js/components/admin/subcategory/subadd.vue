        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6">
            <div class="panel panel-primary panel-outline" style="border:solid 3px lightblue">
              ...
              <h5 class="card-title p-2 font-weight-bold">Add Sub Category</h5>
              ...
              <div class="panel-body p-3">
                ...
                <div class="form-group">
                 ...
                 <button type="submit" class="btn btn-success font-weight-bold">Add Sub Category</button>
                </div>
              </form>
...
data () {
  ...
  methods: {
    subcategorySave () {
      ...
      this.form.post('/subcategory-add')
            .then(({response }) =>{ 
