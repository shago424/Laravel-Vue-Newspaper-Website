        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-6">
            <div class="panel panel-primary panel-outline" style="border:solid 3px #85929E">
              ...
              <h5 class="card-title p-2 font-weight-bold">Add User</h5>
               <div class="text-right p-2">
               <router-link to="/list-user" class="btn btn-warning font-weight-bold"> User List</router-link>
              </div>
              </div>
              <div class="panel-body p-3">
                <form role="form" @submit.prevent='userSave' autocomplete="off">
                ...
                <div class="form-group">
                 ...
                 <button type="submit" class="btn btn-success font-weight-bold">Add User</button>
                </div>
              </form>
