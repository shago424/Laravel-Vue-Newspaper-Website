        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-12">
            <div class="panel panel-primary panel-outline" style="border:solid 3px #1F523F">
              ...
              <h5 class="card-title p-2 font-weight-bold text-white">Add Role</h5>
              ...
              <div class="panel-body p-3">
                ...
                <div class="col-md-8">
                 ...
                 <div class="row pt-3">
                  ...
                  <button type="submit" class="btn btn-success font-weight-bold">Add Role</button>
