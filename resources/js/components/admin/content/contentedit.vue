        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-10">
            <div class="panel panel-primary panel-outline" style="border:solid 3px crimson">
              ...
              <h5 class="card-title p-2 font-weight-bold">Update Content</h5>
               <div class="text-right p-2">
               <router-link to="/list-content" class="btn btn-info font-weight-bold">Content List</router-link>
              </div>
              </div>
              <div class="panel-body p-3">
                <form role="form" @submit.prevent='contentUpdate' enctype="mulipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <button type="submit" class="btn btn-success font-weight-bold">Update Content</button>
                </div>
              </form>
    ...
    // From Category List
     ...
     created(){
      axios.get('/subcategoryList').then((response)=>{
       ...
       axios.get('/editcontent/'+this.$route.params.contentId).then((response)=>{
