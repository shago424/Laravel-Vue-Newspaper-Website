    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="header_bottom">
          <div class="logo_area"><a href="" class="logo"><img src="" alt=""></a></div>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="latest_newsarea" style="height: 40px;"> <span style="background: #000;height: 40px;">Latest News</span>
          <ul id="ticker01" class="news_sticker">
            <li v-for="(argent,index) in getargentPost" v-if="index<11"style="font-size:15px"><a href="#"><img src="`upload/postimage/${argent.image}`" alt="">{{ argent.title | shortlength(90,".......")}}</a></li>
        ...
        <div class="left_content">
          <div class="single_page">
            <ol class="breadcrumb">
              ...
              <li><a href="#">{{ getsinglePost.category.name }}</a></li>
              <li class="active">{{ getsinglePost.subcategory.name }}</li>
            </ol>
            <h1>{{ getsinglePost.title}}</h1>
            <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>{{ getsinglePost.user.name }}</a> <span><i class="fa fa-calendar"></i>{{ getsinglePost.created_at | timeformat}}</span> <a href="#"><i class="fa fa-tags"></i>{{ getsinglePost.category.name }}</a> </div>
            <div  class="single_page_content"> <img class="img-center" :src="`upload/postimage/${getsinglePost.image}`" alt="">
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          ...
          <div class="single_sidebar wow fadeInDown">
            ...
            <a class="sideAdd" href="#"><img src="" alt=""></a> </div>
          <div class="single_sidebar wow fadeInDown">
